...
public class Puzzle_2023_25: PuzzleBaseClass {
    public func solve() {
    ...
    func allReachable(from start: String, in connections: [String: Set<String>]) -> Set<String> {
    ...
    private func solvePart1(str: String) -> Int {
        ...
        for p in [("kns","dct"),("jxb","ksq"),("nqq","pxp")] {
