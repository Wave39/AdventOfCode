...
public class Puzzle_2023_01: PuzzleBaseClass {
    public func solve() {
    ...
    private func stringReplacement(str: String) -> (Bool, String) {
        let replacements = [("one", "1ne"), ("two", "2wo"), ("three", "3hree"), ("four", "4our"), ("five", "5ive"), ("six", "6ix"), ("seven", "7even"), ("eight", "8ight"), ("nine", "9ine")]
        for idx in 0..<str.count {
            for rep in replacements {
                if str.substring(from: idx).starts(with: rep.0) {
                    return (true, str.replaceFirst(of: rep.0, with: rep.1))
                }
            }
        }
    ...
    private func solvePart2(str: String) -> Int {
        ...
        for line in arr {
            ...
            while replacement {
                (replacement, line2) = stringReplacement(str: line2)
            }
