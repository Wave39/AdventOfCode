//
//  Puzzle_2020_20.swift
//  AdventOfCode
//
//  Created by Brian Prescott on 12/20/20.
    ...
    func solvePart1(str: String) -> Int {
        ...
        for line in lines {
            if line.starts(with: "Tile") {
                ...
                let originalGrid = getCharacterGrid(str: tileString, separator: " ")
                var tile = PhotoTile(tileNumber: tileNumber)
                tile.imageData = originalGrid
                tile.edges.append(getCharacterGridEdge(grid: originalGrid, direction: .North))
                tile.edges.append(getCharacterGridEdge(grid: originalGrid, direction: .South))
                tile.edges.append(getCharacterGridEdge(grid: originalGrid, direction: .West))
                tile.edges.append(getCharacterGridEdge(grid: originalGrid, direction: .East))
