...
public class Puzzle_2024_23: PuzzleBaseClass {
    public func solve() {
    ...
    // https://github.com/rbruinier/AdventOfCode/blob/main/Sources/Solutions/2024/Days/Day23.swift

    func parseInput(_ lines: [String]) -> [String: Set<String>] {
    ...
    private func solvePart1(str: String) -> Int {
        ...
        let connections = parseInput(lines)
